...
At the current version Woven falls woefully short of its aims and does just one simple thing - provide a management command ``setupserver`` to setup one or more baseline Ubuntu servers for deploying a Django project.
